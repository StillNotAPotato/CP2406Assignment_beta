...
/**
 * CP2406 Assignment Rainfall Analyser Beta class - Tan Beng Siang
 * Use the Apache CSV package and the RainfallDataSet class
 */
    ...
    public RainfallData analyseRainfallData(String path) throws Exception {
        ...
        for (CSVRecord record : records) {
            ...
            if (rainfallText.isEmpty()) {
                ...
                // Analyse the dat, put it into the desired output format
                // then verify that the recorded date is accurate
